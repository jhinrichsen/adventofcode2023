...
* **Fastest**: Day 06 Part 1 - 207.8 ns (sub-microsecond)
* **Zero allocations**: Days 01, 02, 03 (both parts), 06, 07
* **Sub-millisecond**: Days 01-04, 06, 07
* **Most challenging**: Day 06 Part 2 - 34.4 ms, Day 10 Part 2 - 211 ms, Day 12 Part 2 - 112 ms

Total benchmark suite runtime: ~30 seconds
