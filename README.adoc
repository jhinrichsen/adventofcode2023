...
image::img/day10_example4_poly_tiles.png[Example #4: embedded cells]

Quite impressive. Focussing on the path through the maze:

image::img/day10_example4_poly_tiles_enclosed.png[Example #4: pipeline]
...
image::img/day10_example3_poly_tiles_enclosed.png[Example #3: pipeline]
