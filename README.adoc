...
image:https://gitlab.com/jhinrichsen/adventofcode2023/badges/main/coverage.svg[link="https://gitlab.example.com/jhinrichsen/adventofcode2023/badges/<branch>/coverage.svg",title="coverage report"]
